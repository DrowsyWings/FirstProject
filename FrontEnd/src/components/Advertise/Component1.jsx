...
function Component1() {
  return (
    <div className='bg-transparent w-[92%] z-10 flex flex-col items-center pb-[30px] sm:pb-[115px]'>
        ...
        <button className='px-[7px] sm:px-[14px] md:px-[16px] lg:px-[24px] py-[3px] sm:py-[6px] md:py-[8px] lg:py-[10px] bg-[#FC581C] rounded-[10px] sm:rounded-[33px] text-[#F7F7F7] font-inter text-[9px] sm:text-[16px] md:text-[19px] lg:text-[24px] leading-normal not-italic font-medium mt-[20px] sm:mt-[45px] hover:opacity-80 active:opacity-50 z-10'>Get a Quote</button>
    </div>
  )
}
