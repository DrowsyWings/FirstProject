...
function Component1() {
  return (
    <div className='w-full flex justify-end items-center bg-custom-gradient relative'>
        <div className='w-[320px] bg-[#0F40A8] h-[602px]'></div>
        <div className='w-[12px] h-[558px] bg-[#83CCFF] absolute top-0 left-[40px]'></div>
        <div className='w-[12px] h-[44px] bg-[#3A65B1] absolute top-[558px] left-[40px]'></div>
        <div className='flex h-[425px] absolute right-[103.76px]'>
            <div className='flex w-[461px] pl-[1.63px] mr-[300px] justify-between items-start flex-col'>
