...
function Component1() {
  return (
    <div className="bg-[#0B102C] py-24 px-5 flex justify-between space-x-4">
      <div className="px-10">
        <div className="text-[100px] w-[600px] text-white leading-none">
          PUT YOUR<br></br> BRAND<br></br>IN EVERY<br></br>HAND
        </div>
        <p className="text-white mb-8 mt-6 text-xl">
          Comitment to Quality and Dedication to Deliver
        </p>
        <Link to="/advertise">
